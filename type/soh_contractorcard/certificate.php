...
cert_printtext($pdf, $x + 15, $y + 5, 'L', 'freeserif', 'B', 10, $certificatedate);
cert_printtext($pdf, $x + 15, $y + 20, 'L', 'freeserif', 'B', 10, 'Dear'); 
cert_printtext($pdf, $x + 25, $y + 20, 'L', 'freeserif', 'B', 10, fullname($USER));
cert_printtext($pdf, $x + 15, $y + 38, 'L', 'freeserif', '', 10, 'Thank You for completing the Opera House on-line Safety Induction ');
cert_printtext($pdf, $x + 15, $y + 45, 'L', 'freeserif', '', 10, 'Below you will find your Opera House Site Safety Induction Card.');
cert_printtext($pdf, $x + 15, $y + 50, 'L', 'freeserif', '', 10, 'Unless you have an electronic Opera House swipe card, you will need to keep a copy of the Induction');
cert_printtext($pdf, $x + 15, $y + 55, 'L', 'freeserif', '', 10, 'Card below with you whenever you are on site.  You may be asked to produce this card, along with ');
cert_printtext($pdf, $x + 15, $y + 60, 'L', 'freeserif', '', 10, 'your identification. ');
cert_printtext($pdf, $x + 15, $y + 65, 'L', 'freeserif', '', 10, '');
cert_printtext($pdf, $x + 15, $y + 72, 'L', 'freeserif', '', 10, 'A copy of this letter has been emailed to you, Should you misplace the email or this card, you can ');
cert_printtext($pdf, $x + 15, $y + 77, 'L', 'freeserif', '', 10, 'return to the eLearning portal learning.sydneyoperahouse.com and print a duplicate at any time.');
...
cert_printtext($pdf, $x + 15, $y + 5 + 85, 'L', 'freeserif', 'B', 10, 'Important points:');
cert_printtext($pdf, $x + 15, $y + 5 + 92, 'L', 'freeserif', 'I', 10, '- To report an emergency, dial 2 from an internal phone, or phone 9250-7200 from a mobile');
cert_printtext($pdf, $x + 15, $y + 5 + 98, 'L', 'freeserif', 'I', 10, '- In an emergency evacuation, follow the directions of your warden or instructions over the loud speaker');
cert_printtext($pdf, $x + 15, $y + 5 + 104, 'L', 'freeserif', 'I', 10, '- First aid is available in the Health Centre off the Greenroom, or for urgent medical attention, dial 2');
cert_printtext($pdf, $x + 15, $y + 5 + 109, 'L', 'freeserif', 'I', 10, '- Unless you are in an authorised work zone, keep to green paths and pedestrian crossing in Central Passage.');
...
cert_printtext($pdf, $x + 25, $y + 184, 'L', 'futura', 'B', 12, 'Sydney Opera House Contractor Induction Card');
cert_printtext($pdf, $x + 30, $y + 198, 'L', 'futura', 'B', 16, fullname($USER));
cert_printtext($pdf, $x + 30, $y + 207, 'L', 'freeserif', '', 8, 'has completed ' . $course->fullname);
cert_printtext($pdf, $x + 83, $y + 200, 'L', 'futura', '', 8,'Unique Code:');
cert_printtext($pdf, $x + 83, $y + 205, 'L', 'futura', 'B', 11, $code);
...
cert_printtext($pdf, $x + 32, $y + 226, 'L', 'freesans', 'I', 6,'Contractor Signature');
cert_printtext($pdf, $x + 32, $y + 230, 'L', 'freeserif', 'B', 8, "Date Issued : ".userdate($certdate, get_string('strftimedate', 'langconfig')));
