...
certificate_print_text($pdf, $x, $y - 10, 'C', 'freesans', '', 30, get_string('title', 'certificate'));
$pdf->SetTextColor(0, 0, 0);
certificate_print_text($pdf, $x, $y + 20, 'C', 'freeserif', '', 20, get_string('certify', 'certificate'));
certificate_print_text($pdf, $x, $y + 46, 'C', 'freesans', '', 30, fullname($USER));
certificate_print_text($pdf, $x, $y + 75, 'C', 'freesans', '', 20, get_string('statement', 'certificate'));
certificate_print_text($pdf, $x, $y + 92, 'C', 'freesans', '', 20, $course->fullname);
certificate_print_text($pdf, $x, $y + 160, 'C', 'freesans', '', 14,  certificate_get_date($certificate, $certrecord, $course));
certificate_print_text($pdf, $x, $y + 172, 'C', 'freesans', '', 14, certificate_get_grade($certificate, $course));
